    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($row){
                ...
                $action .= ' <div class="col-auto"><a href="'.route('evaluasis.edit',$row->id).'" class="btn btn-primary btn-sm action" data-bs-toggle="tooltip" title="Edit data evaluasi"><i class="bi bi-pencil-square"></i></a></div>';
                $action .= '</div>';
                return $action;
            })
