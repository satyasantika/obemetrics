                            ...
                            <div class="row mb-1">
                                <div class="col">
                                    <li>
                                        ...
                                        <a href="{{ route('kurikulums.mks.index',[$kurikulum->id]) }}" class="btn btn-sm btn-success mt-2">
                                        ...
                                        <a href="{{ route('kurikulums.joincplbks.index',[$kurikulum->id]) }}" class="btn btn-sm btn-secondary mt-2">
