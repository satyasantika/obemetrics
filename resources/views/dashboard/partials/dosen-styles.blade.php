<style>
    ...
    .dosen-stat-link:hover {
        transform: translateY(-4px);
    }

    .dosen-stat-link:hover .dosen-stat-card {
        box-shadow: 0 12px 28px rgba(0, 0, 0, 0.12);
        border-color: var(--panel-accent);
    }

    .dosen-stat-link:hover .dosen-stat-icon {
        transform: scale(1.1);
    }
