...
<div class="container">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('settings.import.kurikulum-master.upload', $kurikulum->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col">
                                @php
                                    $directSaveTargets = ['kurikulum_bundle', 'join_kurikulum_bundle', 'profil_cpls', 'join_cpl_bks', 'join_cpl_mks'];
    ...
    <div class="row justify-content-center">
        <div class="col">
            @if (!in_array($target, ['join_kurikulum_bundle', 'profil_cpls', 'join_cpl_bks', 'join_cpl_mks'], true) && !empty($preview['rows']))
                <div class="card mt-3">
                    <div class="card-header">
