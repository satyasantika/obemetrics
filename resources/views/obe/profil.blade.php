...
{{--
    Semua modal ditempatkan di luar .card untuk menghindari masalah stacking context CSS.
    .card memiliki backdrop-filter: blur() yang membuat stacking context baru, sehingga
    z-index modal-backdrop (1050 di root) lebih tinggi dari modal dialog (1055 di dalam
    stacking context card), menyebabkan backdrop memblokir interaksi modal.
--}}
...
{{-- Per-profil modals: Edit Profil, Tambah Indikator, Edit Indikator --}}
