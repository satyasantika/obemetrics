        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body bg-light-subtle">
                    <div class="row mb-2">
                        <div class="col">
                            <a href="{{ route('settings.import.kurikulum-master', ['kurikulum' => $kurikulum->id, 'target' => 'cpl_mks', 'return_url' => request()->fullUrl()]) }}" class="btn btn-sm btn-outline-success rounded-pill px-3 fw-semibold shadow-sm mt-1 float-end"><i class="bi bi-upload"></i> Import Interaksi CPL >< MK</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                                        ...
                                        @forelse ($cplBkColumns as $column)
                                            ...
                                            <td>
                                                ...
                                                @elseif (!$isAvailable)
                                                    <span class="text-muted">-</span>
                                                @else
                                                    <form action="{{ route('kurikulums.cplmks.update', ['kurikulum' => $kurikulum->id, 'cpl' => $column['cpl_id'], 'mk' => $mk->id]) }}" method="POST" data-is-locked="{{ $isLocked ? '1' : '0' }}">
                                                        @csrf
                                                        @method('PUT')
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const forms = document.querySelectorAll('form[action*="cplmks"]');
